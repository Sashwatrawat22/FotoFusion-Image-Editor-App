from flask import Flask, request, render_template, url_for, Blueprint, redirect, flash
import cv2
import numpy as np
...
def index():
	...
	if request.method == "GET":
		...
		return render_template("index3.html", source = full_filename, destination = full_filename, result = full_filename)
	...
	if request.method == "POST":
		...
		return render_template('index3.html', source = sfull_filename, destination = dfull_filename, result= rfull_filename)